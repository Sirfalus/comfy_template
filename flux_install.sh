...
# echo "Downloading FramePackI2V_HY_bf16.safetensors..."
# wget -nv -c https://huggingface.co/Kijai/HunyuanVideo_comfy/resolve/main/FramePackI2V_HY_bf16.safetensors -O "$MODELS_BASE_DIR/diffusion_models/FramePackI2V_HY_bf16.safetensors"
